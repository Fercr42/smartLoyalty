...
export const auth: Messages["auth"] = {
  ...
  noAccount: "ยังไม่มีบัญชี? สร้างบัญชี",
  haveAccount: "มีบัญชีแล้ว? เข้าสู่ระบบ",
  forgot: "ลืมรหัสผ่าน",
  resetSent: "เราส่งอีเมลสำหรับเปลี่ยนรหัสผ่านให้คุณแล้ว",
  verifySent: "เราส่งอีเมลยืนยันที่อยู่ของคุณแล้ว โปรดตรวจสอบกล่องจดหมาย (และสแปม)",
  fillBoth: "กรอกอีเมลและรหัสผ่านของคุณ",
  invalidEmail: "อีเมลนี้ไม่ถูกต้อง",
  weakPassword: "รหัสผ่านต้องมีอย่างน้อย 8 ตัวอักษร",
  emailInUse: "อีเมลนี้มีบัญชีอยู่แล้ว โปรดเข้าสู่ระบบด้วยรหัสผ่าน",
  wrongPassword: "อีเมลหรือรหัสผ่านไม่ถูกต้อง",
  tooMany: "ลองหลายครั้งเกินไป โปรดรอสักครู่",
  genericError: "ดำเนินการไม่สำเร็จ โปรดลองอีกครั้ง",
  verifyTitle: "ยืนยันอีเมลของคุณ",
  verifyText: "เราส่งลิงก์ไปที่ {email} โปรดยืนยันเพื่อไม่ให้สูญเสียการเข้าถึงบัญชี",
  resend: "ส่งอีเมลอีกครั้ง",
  resent: "ส่งอีเมลอีกครั้งแล้ว",
};
