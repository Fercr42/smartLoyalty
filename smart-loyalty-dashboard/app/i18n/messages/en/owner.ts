...
export const auth: Messages["auth"] = {
  ...
  resetSent: "We sent you an email to change your password.",
  verifySent: "We sent you an email to confirm your address. Check your inbox (and spam).",
  ...
  emailInUse: "That email already has an account. Log in with your password.",
  wrongPassword: "Wrong email or password.",
  tooMany: "Too many attempts. Wait a few minutes.",
  genericError: "Couldn't complete it. Please try again.",
  verifyTitle: "Confirm your email",
  verifyText: "We sent a link to {email}. Confirm it so you don't lose access to your account.",
  resend: "Resend email",
